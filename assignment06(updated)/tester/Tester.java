...
//			String name, String abbr, String owner, int maxPlayerAge, double battingAvg, wicketsTaken
			System.out.println("Enter name, abbr, maxPlayerAge, battingAvg, wicketsTaken");
			Team tm = new Team(sc.next(), sc.next().toUpperCase(), sc.nextInt(), sc.nextDouble(), sc.nextInt());
